...
* `**/*.g.dart`
* `**/*.freezed.dart`, exclude files generated by [freezed][freezed_link]
* `**/*.mocks.dart`, exclude files generated by [mockito][mockito_link]
* `**/*.mapper.dart`, exclude files generated by [dart_mappable][dart_mappable_link]
* `**/*.tailor.dart`, exclude files generated by [theme_tailor][theme_tailor_link]
